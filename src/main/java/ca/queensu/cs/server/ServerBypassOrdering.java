...
public class ServerBypassOrdering {
	...
	private ReaderBypassOrdering reader; //queueWriter because it can write into the queue
	...
	public ServerBypassOrdering(final String ipAddress, final int portNumber, Semaphore sem, String args0) throws IOException {
		...
		reader = new ReaderBypassOrdering(capsuleNames, sem);
